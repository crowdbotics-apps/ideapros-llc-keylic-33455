...
## Project Structure
    ...
    ├── ideapros_llc_keylic_33455  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_keylic_33455`
...
2. Clone this repo and `cd ideapros_llc_keylic_33455`
